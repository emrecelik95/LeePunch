...
static NetworkInformation* delegateObject = nil;
...
const char * getLocalWifiIpAddress()
{
    if (delegateObject == nil)
        delegateObject = [[NetworkInformation alloc] init];
    
    return MakeStringCopy([[delegateObject primaryIPv4Address] UTF8String]);
}